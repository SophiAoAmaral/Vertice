...
export const Sobre = () => {
  ...
  return (
    <section className='container'>
        <div className='grid md:grid-cols-2 gap-7 mt-20 mb-20'>
            <div>
                ...
                <h1 className='text-8xl font-black uppercase mb-3'>As marcas que você <span className='text-azul'>confia</span></h1>
            ...
            <img src={fachada} alt="" className='h-130 rounded-2xl' />
        </div>
